...
<body class="bg-gradient-primary">
  ...
  background-size: 100% 100%;
              ...
              <div class="col-lg-6 d-none d-lg-block bg-l1"></div>
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Welcome to Fix n Right</h1>
                  </div>
                  <form class="user" role="form" action="login.php" method="post">
                    ...
                    <div class="form-group">
                      <div class="custom-control custom-checkbox small">
                        ...
                        <a href="register.php"> <input type="button" class="custom-control-input" id="customCheck">
                        <label class="custom-control-label" for="customCheck">Sign Up</label></a>
                      </div>
                    </div>
